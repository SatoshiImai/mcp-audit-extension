...
from auditable_mcp.degradation import MANDATORY, UnnegotiatedCallError, transport_for
from auditable_mcp.host import AuditHost
from auditable_mcp.in_process import InProcessTransport

_TOOL = AuditCapability()
_REQUIRES_COUNTERSIGN = AuditCapability(countersign='host')
...
def test_a_tool_that_requires_a_countersign_cannot_degrade() -> None:
    ...
    with pytest.raises(ValueError, match='MANDATORY'):
        transport_for(negotiate_capability(None, _REQUIRES_COUNTERSIGN), _wire(), _self_hosted())
